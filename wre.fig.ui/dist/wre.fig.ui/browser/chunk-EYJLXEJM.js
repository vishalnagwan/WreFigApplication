...
var SignalrService = class _SignalrService {
  constructor(auth) {
    this.auth = auth;
    this.instructionUpdated$ = new Subject();
    this.alertCreated$ = new Subject();
  }
  startAsync() {
    return __async(this, null, function* () {
      ...
      if (!token)
        return;
      this.hub = new HubConnectionBuilder().withUrl(environment.hubUrl, { accessTokenFactory: () => token }).withAutomaticReconnect().configureLogging(LogLevel.Warning).build();
      this.hub.on("instructionsUpdated", (branchId, updatedByName) => this.instructionUpdated$.next({ branchId, updatedByName }));
      this.hub.on("alertCreated", () => this.alertCreated$.next());
      yield this.hub.start();
    });
  }
  joinBranch(branchId) {
    return __async(this, null, function* () {
      yield this.hub?.invoke("JoinBranch", branchId);
    });
  }
  leaveBranch(branchId) {
    return __async(this, null, function* () {
      yield this.hub?.invoke("LeaveBranch", branchId);
    });
  }
  stopAsync() {
    return __async(this, null, function* () {
  ...
  static {
    this.\u0275fac = function SignalrService_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _SignalrService)(\u0275\u0275inject(AuthService));
    };
  }
  static {
...
//# sourceMappingURL=chunk-EYJLXEJM.js.map
